...
class BehaviorModel : public VIPRA::Modules::Module<BehaviorModel<pedset_t, obstacles_t, goals_t>> {
 public:
  ...
  void initialize(pedset_t& pedset, obstacles_t& map, goals_t& goals, VIPRA::seed seed)
  {
 ...
 private:
  ...
  std::vector<Behaviors::HumanBehavior<pedset_t, obstacles_t, goals_t>> _behaviors;

  void load_behaviors(VIPRA::seed seed)
  {
    Behaviors::BehaviorBuilder<pedset_t, obstacles_t, goals_t> builder;
