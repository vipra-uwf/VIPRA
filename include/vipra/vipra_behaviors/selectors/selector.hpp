...
class Selector {
 ...
 private:
  ...
  [[nodiscard]] auto select_peds_from_group(SubSelector& /*selector*/, Simpack pack,
  ...
  [[nodiscard]] static auto filter_used_peds(
  ...
  void update_ped_groups(const VIPRA::idxVec& /*selectedPeds*/, SubSelector& /*selector*/,
                         BehaviorContext& /*context*/, std::string const& /*unused*/);
  void sort_groups();
};
