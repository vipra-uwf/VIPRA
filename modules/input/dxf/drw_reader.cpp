...
// TODO(Rolland): issue #59 need to find and fix errors in loading DXF files here
...
//  */
// auto DrwReader::get_polygon(std::vector<std::shared_ptr<DRW_Vertex>>& vertexList)
...
//     std::vector<std::shared_ptr<DRW_Vertex2D>>& vertexList) -> std::vector<VIPRA::f3d>
// {
//   std::vector<VIPRA::f3d> points;
...
//  * @return std::vector<VIPRA::f3d>
//  */
// auto DrwReader::get_arc_as_polygon(DRW_Coord center, double radius, double start_angle,
...
//     VIPRA::Log::debug("Adding Spawn at {}, {}, {}", shape.center().x, shape.center().y,
//                       shape.center().z);
...
//   auto points =
//       DrwReader::get_arc_as_polygon(center, radius, data.staangle, data.endangle);
