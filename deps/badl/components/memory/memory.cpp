...
#define BADL_AGENT_INTERNAL_STATE_COMPONENTS_TEMP \
  BADL_AGENT_INTERNAL_STATE_COMPONENTS
#define BADL_AGENT_INTERNAL_STATE_COMPONENTS BADL::Memory
#endif
...
void Memory::add_memory_actuator(
    ...
    BADL::Environment<BADL_STIMULI_TYPES>& /*unused*/,
    BADL::ComponentParams const& params, BADL::time time)
{
  agent.get_component<BADL::Memory>().add_memory(
    ...
    BADL::ComponentParams const& params, BADL::time /*unused*/) noexcept -> bool
{
  ...
  return agent.get_component<BADL::Memory>().has_memory(test);
}
...
#ifdef BADL_BUILD_MACRO_ON
#undef BADL_AGENT_INTERNAL_STATE_COMPONENTS
