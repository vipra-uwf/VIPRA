...
// TODO(rolland): add in special characters like @
...
Action <- 'action'i ':' SubAction (',' SubAction)*
SubAction <- #activation_calls#
Condition <- 'condition'i ':' SubCondition (('and'/'or') SubCondition)*
SubCondition <- #query_calls#
)";
