 ...
 * @param goals : 
 */
void Selector::run_selectors(const VIPRA::idxVec& selectorIdxs, std::string const& behaviorName,
                             Simpack pack) {
 ...
 * @return VIPRA::idxVec 
 */
auto Selector::select_peds_from_group(SubSelector& selector, Simpack pack, std::string const& behaviorName)
    -> VIPRA::idxVec {
...
void Selector::update_ped_groups(const VIPRA::idxVec& selectedPeds, SubSelector& selector,
                                 BehaviorContext& context, std::string const& behaviorName) {
 ...
 * @return VIPRA::idxVec 
 */
auto Selector::filter_used_peds(const VIPRA::idxVec& peds, std::vector<bool> const& used) -> VIPRA::idxVec {
  VIPRA::idxVec ret;
...
void Selector::add_sub_selector(SubSelector const& subSelector) { _subSelectors.emplace_back(subSelector); }
