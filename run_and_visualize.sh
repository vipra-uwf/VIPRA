...
if [[ "$1" == "r" ]] || [[ "$2" == "r" ]] || [[ "$3" == "r" ]]; then
echo "Starting Sim"
./vipra -map=temp/museum.dxf -peds=maps/pedestrians/a320_pedestrians.json -params=temp/module_params_no_file.json -modules=temp/sim_config.json
...
python3 tools/trajectories_visualizer/visualize.py -peds sim_output/0/trajectories.json -obs temp/museum.dxf -outpath museum_test.mp4 -xDim -5,65 -yDim 3,80
...
# python3 tools/trajectories_visualizer/visualize.py -peds sim_output/0/trajectories.json -obs temp/closing_geometry_test.dxf -outpath small_test.mp4 -xDim 0,40 -yDim 0,30
